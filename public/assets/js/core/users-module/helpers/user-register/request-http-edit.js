 ...
 */
class UserEditRequestHttp {
    /**
     * Permite invocar al servicio de Registro de Usuarios.
     * @param {UserEditForm} form instancia del formulario de registro
     ...
     */
    static send(form) {
        Logger.logObject("Usuario a editar", form.data);
        $.ajax({
            url: form.url_user_edit,
            method: 'POST',
            data: form.data,
